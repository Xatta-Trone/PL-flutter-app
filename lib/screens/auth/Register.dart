                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  // helperText: 'According to your student ID',
                              ...
                              TextFormField(
                                controller:
                                    _authController.emailRegisterController,
                                textInputAction: TextInputAction.next,
                              ...
                              Visibility(
                                ...
                                child: TextFormField(
                                  controller:
                                      _authController.studentIdController,
                                  textInputAction: TextInputAction.next,
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                              ...
                              // ),
                              TextFormField(
                                controller: _authController.meritPosController,
                                textInputAction: TextInputAction.next,
                              ...
                              OutlinedButton(
                                style: ElevatedButton.styleFrom(
                                  ...
                                  minimumSize:
                                      const Size.fromHeight(50.0), // NEW
                                ),
                                onPressed: () {
                                  if (kDebugMode) {
                                    print('pressed');
